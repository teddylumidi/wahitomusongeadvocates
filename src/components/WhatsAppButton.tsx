export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 block h-16 w-16 overflow-hidden rounded-full shadow-[0_10px_28px_rgba(0,0,0,0.24)] transition-transform duration-300 hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 sm:bottom-7 sm:right-7 sm:h-[72px] sm:w-[72px]"
    >
      <img
